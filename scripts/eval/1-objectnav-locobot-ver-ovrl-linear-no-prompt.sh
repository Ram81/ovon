...
TENSORBOARD_DIR="tb/objectnav/ver/hm3d_6cat/resnet_ovrl_linear/seed_1_no_prompt/evals/"
EVAL_CHECKPOINT_DIR="data/new_checkpoints/objectnav/ver/hm3d_6cat/resnet_ovrl_linear/seed_1_no_prompt"
...
srun python -um ovon.run \
  ...
  habitat_baselines.checkpoint_folder=${EVAL_CHECKPOINT_DIR} \
