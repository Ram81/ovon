...
TENSORBOARD_DIR="junk/tb/objectnav/ddppo/resnetclip/hm3d_6cat/seed_1"
CHECKPOINT_DIR="junk/data/new_checkpoints/objectnav/ddppo/resnetclip/hm3d_6cat/seed_1"
DATA_PATH="data/datasets/objectnav/hm3d/curriculum/v1"
...
python -um ovon.run \
  ...
  habitat.dataset.type="ObjectNav-v2" \
