...
#SBATCH --exclude=cheetah,cyborg,xaea-12,megazord,megabot
...
TENSORBOARD_DIR="tb/objectnav/ver/hm3d_6cat/resnetclip_rgb_text_attnpool/seed_1"
CHECKPOINT_DIR="data/new_checkpoints/objectnav/ver/hm3d_6cat/resnetclip_rgb_text_attnpool/seed_1"
