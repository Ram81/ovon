...
TENSORBOARD_DIR="tb/objectnav/ver/resnetclip_rgb/hm3d_v0.2_22_cat/stretch/seed_1"
CHECKPOINT_DIR="data/new_checkpoints/objectnav/ver/resnetclip_rgb/hm3d_v0.2_22_cat/stretch/seed_1"
DATA_PATH="data/datasets/objectnav/hm3d_semantic_v0.2/v1"

srun python -um ovon.run \
  --run-type train \
  --exp-config config/experiments/ver_ovon_hm3d.yaml \
