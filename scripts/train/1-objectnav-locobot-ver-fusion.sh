...
#SBATCH --exclude=cheetah,cyborg,megazord
...
TENSORBOARD_DIR="tb/objectnav/ver/hm3d_6cat/resnetclip_rgb_text_late_fusion/seed_2"
CHECKPOINT_DIR="data/new_checkpoints/objectnav/ver/hm3d_6cat/resnetclip_rgb_text_late_fusion/seed_2"
...
srun python -um ovon.run \
  ...
  +habitat_baselines.rl.ddppo.late_fusion=True \
