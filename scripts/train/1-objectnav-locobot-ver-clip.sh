...
#SBATCH --exclude=cheetah,cyborg,megabot
...
TENSORBOARD_DIR="tb/objectnav/ver/hm3d_6cat/resnetclip_rgb_text/seed_1_no_prompt/"
CHECKPOINT_DIR="data/new_checkpoints/objectnav/ver/hm3d_6cat/resnetclip_rgb_text/seed_1_no_prompt/"
