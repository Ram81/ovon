...
from ovon.utils.utils import load_image, load_json, save_image


def visualize_annotations(annotations, output_path):
    obs_path = list(annotations.values())[0]["observation"] # .replace("val", "val_full")
...
if __name__ == "__main__":
    ...
    visualize(args.path, args.output_path)
